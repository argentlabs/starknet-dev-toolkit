...
import type { Erc20Contract, ProxyWithImplementationContract } from "../contracts/contractTypes.js";
import type { LoadContractMixin } from "../contracts/loadContract.js";
...
export class TokenManager {
  ...
  constructor(private manager: LoadContractMixin) {}
