...
export class WebauthnOwner extends KeyPair {
  ...
  public signHash(transactionHash: string): WebauthnSignature {
...
export class LegacyWebauthnOwner extends WebauthnOwner {
  ...
  public signHash(transactionHash: string): LegacyWebauthnSignature {
...
export class EstimateLegacyWebauthnOwner extends EstimateWebauthnOwner {
  ...
  public override async signRaw(_messageHash: string): Promise<ArraySignatureType> {
