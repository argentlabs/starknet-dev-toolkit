...
async function profileGasUsage(transactionHash, manager, allowFailedTransactions = false) {
...
export function newProfiler(manager) {
    const profiles = {};
    return {
        async profile(name, transactionHash, { printProfile = false, allowFailedTransactions = false } = {}) {
